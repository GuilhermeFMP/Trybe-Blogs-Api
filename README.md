...
Sexto projeto de Back-End fornecido pela instituição Trybe , onde criamos uma api restful com a arquitetura MVC, utilizando o ORM Sequelize e JWT.


## Aprendizados

Aprendi a criar uma Api utilizando arquiteturas de softwares, além de aprender sobre as ORMS e a validação de tokens com o JWT.

## Stack utilizada

**Back-End:** Express.js, Sequelize, JWT, Js, Mocha, Chai, Sinon e Node.js.
...
```bash
  git clone git@github.com:GuilhermeFMP/Trybe-Blogs-Api.git
  cd Trybe-Blogs-Api
  npm install
```
